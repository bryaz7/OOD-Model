...
def load_dataset(data_name, data_type='full'):
    with open('./dataset/COURSES/data_full.json', 'r') as f:
        data = json.load(f)
...
def frequency_OOD_detect(args):
    ...
    if data_type == "sst":
        ...
        ood_df  = load_dataset('prompts_oos_test', data_type=data_type) 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_type', default='courses', choices = ['courses', 'sst'])
